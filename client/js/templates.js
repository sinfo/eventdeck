(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="ink-navigation"><div><ul class="menu horizontal black"><li class="heading"><a href="/">EventDeck</a></li><li><a href="/">home</a></li><li></li></ul></div></nav><div class="ink-grid"><main data-hook="page-container"></main></div></body>';
    };
