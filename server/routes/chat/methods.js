...
function update(id, chat, cb) {
  Chat.findOneAndUpdate({$or:[{id: id}, {_id: id}}, chat, function(err, _chat) {
    if (err) {
...
function get(id, cb) {
  Chat.findOne({$or:[{id: id}, {_id: id}}, function(err, chat) {
    if (err) {
...
function remove(id, cb) {
  Chat.findOneAndRemove({$or:[{id: id}, {_id: id}}, function(err, chat){
    if (err) {
