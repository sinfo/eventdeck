...
function update(id, company, cb) {
  ...
  Company.findOneAndUpdate({$or:[{id: id}, {_id: id}]}, company, function(err, _company) {
    if (err) {
...
function get(id, cb) {
  Company.findOne({$or:[{id: id}, {_id: id}]}, function(err, company) {
    if (err) {
...
function remove(id, cb) {
  Company.findOneAndRemove({$or:[{id: id}, {_id: id}]}, function(err, company){
    if (err) {
